...
```yaml
  ...
  # crimp/ferrule sub-items, leaving the production-relevant fields (color,
  # gauge, length, pinout). Full part-number detail still appears in the BOM.
  # Set True to restore the full in-box part numbers.
  show_part_numbers: <bool>    # Default = False
